...
const Welcome = () => {
  ...
  console.log("Here is ConnectedAccount", connectedAccount);

  const handleSubmit = (e) => {
    console.log("Logic For HandleSubmit");
  ...
  return (
    <>
      <h3 className="text-white text-center text-gradient text-3xl">
        Hello there, My Name is Ankit Jha. <br />{" "}
        <p className="text-lg">
          I welcome you to the world of Blockchain and crytocurrencies
        </p>
        <p className="text-sm">
          Connect your Wallet and start sending ethereum transactions.
        </p>
      </h3>
